...
const Home = () => {
    ...
    const searchMovies = async(e)=>{
      try {
        e.preventDefault()
        let url=`https://api.themoviedb.org/3/search/tv?query=${search}&api_key=7e543c5d98f9db66d83f81acc2832294`
...
useEffect(()=>{
    fetch('https://api.themoviedb.org/3/tv/popular?api_key=7e543c5d98f9db66d83f81acc2832294')
    .then(res=>res.json())
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <Nav.Link to={'./Home'}>Tv Shows</Nav.Link>
            </Nav>
